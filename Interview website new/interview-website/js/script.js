...
function renderHeader() {
  ...
  mount.innerHTML = `
    <div class="header-inner">
      <a href="${r}index.html" class="brand"><span class="brand-mark">IF</span>${SITE.name}</a>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-col">
          <a href="${r}index.html" class="brand" style="margin-bottom:14px;"><span class="brand-mark">IF</span>${SITE.name}</a>
